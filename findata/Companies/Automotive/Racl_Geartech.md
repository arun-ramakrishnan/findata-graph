...
- **Explains how being an approved vendor with BHEL (Bharat Heavy Electricals Limi provides a competitive advantage by allowing direct business…**

> "You know normally in all PSU's the business happens through gems portal. It means it' tendering process, but for very precise components or some critical components, they ha separate procedure where this to you as an approved vendor. Now technically we can be to one RFQ from t…"

> "So, then we have got a privilege that if any urgent requirement is there, any business is there, BHEL can simply send us another queue send the offer and then that's it and if $w$ get the nomination, we start producing. So, this is a slightly again, we say that we maint our pr…"
> — Gursharan Singh, Chairman \& Managing Director [^chatter-The_Push_and_Pull]
...
- **The Chairman &amp; Managing Director expresses optimism for significant economic improvement in both India and globally in the coming year 2…**
...
> — Mr. Gursharan Singh, Chairman &amp; Managing Director [^chatter-Playing_the_Long_Game]

- **Europe is expected to rebound positively from a 2024-2025 plateau, driven by large infrastructure, defense, and energy spending, which bodes…**

> "globally Europe achieved a plateau in 2024 and 2025. So, whatever now is going to happen, it is going to happen in the plus direction only because of political scenario. Europeans are spending in a big way into infrastructure projects, particularly in the defe projects and par…"
> — Mr. Gursharan Singh, Chairman &amp; Managing Director [^chatter-Playing_the_Long_Game]

- **Current revenue growth is predominantly fueled by recovery and increased orders from existing customer projects, many of which are now deliv…**

> "So, there is absolutely no new project which has contributed to being revenue growth. BMW cars prototyping is happening somewhere. The pickup is good there. Second many existing projects which were earlier... many for existing projects from customers have sh good recovery sign…"
> — Mr. Gursharan Singh, Chairman &amp; Managing Director [^chatter-Playing_the_Long_Game]

- **RACL holds long-term ambitions to diversify beyond gears and automotive into futuristic technologies like robotics and humanoids, though cur…**
...
- **12/12/25, 7:32 PM The Chatter: Playing the Long Game - The Chatter by Zerodha — Mr. Gursharan Singh, Chairman &amp; Managing Directo…**
...
> — Mr. Jitender Jain, Chief Financial Officer [^chatter-Playing_the_Long_Game]

- **RACL Geartech is strategically entering the defense manufacturing sector, viewing as an initial step towards sustainable long-term growth as…**
...
- **RACL Geartech | Small Cap | Auto Ancillary RACL Geartech Limited is a leading provider of automotive components in India an is a globall…**

> "Regarding revenue, we always say that we have an ambitious growth plan to grow by 15

20% per year.


Consider that 15% of 100 crores is 15 crores, while 15% of 500 crores is 75 crores. You ca

understand that, over the next 3-4 years, we will again be targeting a doubling of …"
> — Gursharan Singh, Chairman & Managing Director [^chatter-Borosil_Orchid_Welspun]

- **After KTM’s financial troubles hurt RACL’s volumes, management says the custom has recovered and its 2027 production plans look strong.**

> "I already explained that KTM has bounced back and has almost reached pre-COVID

levels. In fact, their Model Year 27 means that the vehicles they start producing from

September will be classified as Model Year 2027. They have very good plans for 2027, an

the business is back…"

- **Bajaj’s ownership of KTM hasn’t disrupted RACL’s longstanding relationship with Austrian business; new model opportunities are already comin…**

> "We are already exporting to KTM. For sourcing from India, we are already exporting to

Austria, and we have been exporting to Austria for the last 15 years. Our relationship is


https://thechatter.zerodha.com/p/the-chatter-borosil-orchid-welspun?publication_id=4898760&post_id…"
...
> "Regarding Royal Enfield, we conveyed that commercial supplies started from January. W

have already completed approximately 8 months of turnover. As we said, we have been

nominated for roughly 10,000 sets per month. When I say sets, I mean motorcycles. We a

working at that l…"
> — Prabh Mehar Singh, Chief Operating Officer / Management [^chatter-Borosil_Orchid_Welspun]

- **RACL sees structural outsourcing opportunities as Indian OEMs move into higher performance motorcycles requiring more sophisticated transmis…**

> "We are now creating a niche of our own through the premiumization of the entire produ

portfolio of these companies. For example, TVS is now launching motorcycles above 350

which is more than what they did in the past. We are the single source for the entire gear

train for a…"

- **8/28/26, 1:38 PM The Chatter: Borosil, Orchid, Welspun, KRN, & More — Management As OEMs focus their capital on vehicle assembly and expansi…**

> "You are right. Eventually, an OEM would like to focus on making the assembly. Assemb

is the king of the supply chain, so the OEMs want to retain that commanding position.


If they invest in people and costs to manufacture the components as well, they lose the sc

at which cu…"

- **ZF is discussing a similar product with another OEM for China; management says i early-stage but potentially significant.**

> "In parallel, although it is still at a very early stage, the customer is discussing a similar

product with another OEM for the Chinese market. If that opportunity materializes, it

could significantly change everything we have discussed here, but these are still very earl

up…"

- **RACL is already investing for an electric power-steering programme through ZF th management describes as another potentially large project.…**

> "The other ZF project, which you already know about, is in the electric power steering

segment, for which we are now investing. That project is on track, and commercial suppl

should start from the end of 2027 or the middle of 2028. It is for an American OEM and

also expected…"

- **With automotive visibility already established for the next few years, RACL is looki at areas where its precision-manufacturing and traceabi…**

> "The first area we have identified is aerospace for civil aviation. We feel that this area is

growing very rapidly, and the indications are very strong, particularly for Airbus. Boeing

does not yet have such a large forecast, but Airbus is progressing in a significant way.


…"

- **RACL believes some of its existing manufacturing technologies can be adapted to emerging robotics and actuator applications, with Europe as…**

> "The second area we are identifying is a degree of diversification in the area of actuator

as you mentioned. We are also trying to diversify to some extent into small micromotors

actuators, and related products. We believe this area also has significant potential.
...
> "This is the strength of our export business. Leaving BMW aside, in any export business,

wherever we supply a component, we remain the sole supplier of that component until th

end of the product’s life cycle. This is part of our formal agreement."

- **Management confirmed the sharp increase in European sourcing enquiries, linking to geopolitical disruption and China+1 diversification.**

> "Your feedback is correct. There has been a surge in RFQs. However, many times they ar

not only RFQs; they are also RFIs. Geopolitical conditions are very volatile. Supply chai

are being rewritten, and supply and logistics routes are being rewritten. Therefore, there
...
> — Jitender Jain, Chief Financial Officer [^chatter-Threads_in_the_data]
...
> — Gursharan Singh, Chairman & Managing Director [^chatter-Threads_in_the_data]
...
> — Prabh Mehar Singh, Chief Operating Officer [^chatter-Threads_in_the_data]
