...
![[images/TCS_IFB_Gulf_Oil_p1_img1.jpeg]]
...
![[images/TCS_IFB_Gulf_Oil_p2_img2.jpeg]]
...
"As I have mentioned, I am of the firm belief that every technology disruption enhances tech spending and is a significant opportunity for a company like TCS. But the magnitu of the possibility of AI is going to be so huge that, in my firm belief, it is the biggest opportunity TCS has had so far."
...
Hinduja Global Solutions is a global business process management and digital serv company. The company provides customer experience, digital transformation, and led solutions across sectors including BFSI, healthcare, retail, and public services. I also operates a media business through NXTDIGITAL, which includes digital television and broadband services.
...
"FY2026 has been our strongest year ever, with 79 new clients signed on across BPM an Digital services."

"I feel this is the best year we ever had on new logos. With these signings, we are enterin FY2027 with meaningful revenue visibility."
...
"Realized AI is HGS's operating model for deploying AI in production. Not experimentation. It's a risk that is shared and not transferred to the customer. We pick o client process, identify the problem, and solve it. And we take it from zero to production 90 days."
...
"Today, Agent $ X^{ \mathrm{TM}} $ is moving from capability to scale. We now have 23 active customers or 21 AI assistants in production."

"Importantly, these are not pilots anymore. They are embedded into real workflows in cl operations."
...
"CelerityX, which is the enterprise broadband business that we developed barely a year a half ago, revenues have increased for the enterprise business by 2x this year. The total contract value has increased by 5x."

— Vynsley Fernandes, Whole Time Director, HGS & CEO, NXTDIGITAL Media Busi

The company signed an MoU with the Uttar Pradesh government for Project Gang large-scale broadband rollout targeting two million households through locally trai digital entrepreneurs.

"Project Ganga is basically a large-scale digital inclusion initiative in the state to be abl provide that connectivity."

"When the project is completed, over 2 million households across the state of Uttar Prad will get connected with high-speed broadband over the next two to three years."

— Vynsley Fernandes, Whole Time Director, HGS & CEO, NXTDIGITAL Media Busi

A positive shift in broadband customer behaviour is visible, with more users opting higher-speed plans at the point of sign-up, reflecting improved affordability and ris data consumption.

"About a year ago, 10.7% of our users were in the high-speed segment above 100 Mbps, this has now risen to 15%."

"From 54% last year, entry-level plan subscribers have dropped to 46%, signalling that n consumers are adopting a higher base plan at start."

- Vynsley Fernandes, Whole Time Director, HGS & CEO, NXTDIGITAL Media Busi

The company's net treasury and cash surplus of Rs. 5,346 crores gives management flexibility to fund strategic investments without compromising shareholder returns
...
Despite a negative standalone EPS for FY2026, management recommended a divide as a signal of confidence in the company's trajectory.
...
"There is enough cash assets in the company and we are not concerned about shortage of funds as we go through the transformation."
...
Everest Kanto Cylinder (EKC) is a company with manufacturing units in India and in Middle East. They manufacture various industrial cylinders for gases like oxygen, hydrogen, nitrogen, among others, as well as allied products. EKC also produces CM cylinders for vehicles and beverage cylinders. They are involved in the manufacturing of a wide range of industrial equipment.

## [Concall]

Investors questioned the prolonged weakness in the Dubai operations. Management acknowledged operational challenges but emphasized that demand remains intact a order visibility is improving.
...
Given Everest Kanto's larger exposure to commercial vehicles, management was asl whether higher gas prices could hurt fleet adoption.
...
"We also saw encouraging traction in higher value-added segments such as semiconduct and defence, which contributed positively to our product mix and supported overall mar expansion."
...
The company outlined its broader strategic opportunity set beyond automotive CN
...
While EV adoption continues, management believes gas-based mobility will contin to play an important role in India's energy transition.

"Over the medium to long term, India is expected to remain a multi-fuel economy, with playing an important role in mobility and the broader energy transition."

Puneet Khurana, Managing Director

Management highlighted an important industry trend supporting long-term cylind demand.
...
This suggests growth is becoming more diversified beyond automotive CNG cylind
...
Greenleaf Envirotech is a Gujarat-based environmental infrastructure company specialising in wastewater treatment, environmental engineering, laboratory servic and compliance consulting. Over 15 years, it has built long-term relationships with clients like L&T, Reliance, Tata Motors, and Maruti Suzuki. The company is now transitioning from a pure EPC model toward owning and operating environmental infrastructure, while expanding into ESG consulting and circular economy services

## [Concall]

Management described the company's multi-service model not as a diversification strategy but as different stages of the same value chain, designed to deepen and ext client relationships over time.

"Our laboratory business allows us to engage with customers before a project begins. Our consulting and compliance services help them navigate regulatory requirements. Our

engineering and EPC capability help create the infrastructure. Our O&M services allow to remain involved long after project commissioning."
...
"For new orders, we generally bid for projects at a 15% to 20% gross margin. We are not taking any project below a 15% gross margin. So, we will always maintain between 15% 20% EBITDA for all projects, both existing and new."

— Kalpesh Gopti, Chairman & MD, Greenleaf Envirotech

The CETP model carries a 25 to 30-year operational runway with inflation-linked pricing after the initial two-year commitment period, and capacity can be doubled Phase 2.

"Currently in Phase 1, we have developed a capacity for 4,000 textile machines, but in Phase 2, we can increase that up to 8,000. So, this project will continue to serve the text industries in that particular region for approximately 25 to 30 years."
...
Management sees no meaningful increase in competitive intensity, pointing instead a massive expansion of government spending on water infrastructure as a demand tailwind that benefits all serious EPC players.
...
Court-ordered industrial closures for non-compliance are creating a new category of forced private-sector demand for wastewater treatment infrastructure, independent government budgets.
...
Gulf Oil Lubricants India is a leading lubricant manufacturer serving automotive, industrial, and OEM customers across India. The company is focused on gaining market share through volume-led growth, capacity expansion, and new opportuniti in emerging segments such as data-centre cooling fluids.
...
"We've seen unprecedented cost increase right from packaging material to our base oils which go similar to crude and chemicals which are additives. There has been significant increases happening on a monthly basis and we are passing on what the cost increase is trying to manage our margins."
...
"We are also in a very good position supply-wise in terms of getting the supply chain right and able to meet the need of our B2B customers. We have about 40 plus OEMs and that very important to get the supply security because that is what customers and our business partners look for."
...
"We have two products ready. We are now talking to actual data centers to put our products in terms of validation. We will make a play in that and hopefully be able to announce so sort of tie-ups in a few months."
...
One of the most important comments from the call. The company highlighted that the current order book already provides complete visibility on its internal FY28 revenue plan and supports double-digit growth over the medium term.
...
"They're coming in very strong on both the Clean Air Powertrain side and also on the sh absorber side."
...
"The traction is so good that we have three to four OEMs that are already interested in product."

"This covers Indian OEMs, Japanese and also Korean OEMs... and also European OEMs

— Arvind Chandrasekharan, Whole-Time Director & CEO

This is arguably the biggest regulatory growth opportunity discussed during the cal
...
Tenneco has historically not supplied Clean Air products to the largest passenger vehicle OEM in India, limiting growth. That changes with a new gasoline particula filter program.
...
"The markets in the US and Europe are sliding back from an EV to more of a compromi
...
"I see this as an immediate 15% to 20% improvement in our ability to compete in the glacier market."
...
"The time to market is faster, the cost of that product is less, the margins are better, and capital efficiency is the highest."
...
"India is now equal in technology, whether you look at Clean Air exhaust systems or wit shock absorbers."
...
"Some of the real low volume applications like construction equipment can be even like to 15X."
...
"If we do enter the two-wheeler market for Clean Air or for suspension, it will be somethat brings something unique to that segment."
...
The company intends to maintain very high local sourcing levels even as it introduce new technologies.
...
"My priority is to ensure the processes the team already put into place are tightened furt We are focusing on improving cost structures, managing the dealer network, and plugging

leakages in trade schemes."

"We have identified approximately 10,500 outlets that contribute the most volume. Now must maximize placement and extraction from those outlets."

— Sandeep Joseph Abraham, MD & CEO, Home Appliances Division, IFB Industries

Commodity and forex pressures have continued into the new financial year, with a 49 crore negative impact already visible in April and May alone, partially offset by 1 29 crores of cost measures and Q1 price increases.

"Raw material costs are increasing further, including both commodities and forex. April May are seeing a negative impact that has not yet been fully offset by our cost initiatives.
...
"Our front loader market share is about 23%. This is despite not operating in the 12 kg category, which is 13% of the market. If you exclude that 12 kg segment, our share would about 25.5% to 26%."

"We will be plugging that gap this year by launching 13 kg and 14 kg products."

— Sandeep Joseph Abraham, MD & CEO, Home Appliances Division, IFB Industries

The brand is management's primary confidence anchor for expanding into new categories, with the argument that established outlet relationships from washing

machines reduce the entry barrier for ACs and refrigerators.

"In categories where we have entered, we have achieved significant share because our products are well-received. The IFB umbrella brand stands for quality products and serv which is our biggest asset."
...
The Engineering division is targeting 20% to 25% revenue growth over the next two three years, supported by capacity additions and new product lines including EV battery packs, motorcycle chains, and brake discs mandated under new legislation.

"Over the next 2 to 3 years, we plan for 20% to 25% growth in existing business. We are adding new revenue streams like EV battery packs, motorcycle chains, and brake discs, which have become mandatory under new legislation."

Jayanto Patnaik, Engineering Division, IFB Industries

The engineering division's new order win target for FY2027 has been raised to Rs. 3 crores, more than double last year's Rs. 153 crore actual, with management attributi the FY2026 miss to the long validation cycles inherent in the B2B automotive supply chain.
...
"For FY27, we have a 350 crore target for new orders. Many are already in the validatio stage."

Jayanto Patnaik/Amit Ghosh, Engineering Division, IFB Industries

## Srigee DLM Nano Cap Consumer Durables

Srigee DLM provides end-to-end plastic manufacturing solutions with a design-dri approach to enhance functionality and manufacturability. They serve both OEM an ODM clients, offering comprehensive services in the plastic manufacturing industr
...
"We are moving to a new facility with a plot size of 10,850 square meters, which is 4 tim our current size."

— Suresh Kumar Singh, Whole-Time Director

Management sees polymer compounding as one of the biggest growth opportunitie within the company.
...
Management suggested current volumes represent only a small share of the potenti opportunity.
...
Management acknowledged dependence on a few customers and intends to diversi
...
"We made very large purchases of polymer in February and March to nullify the effect o the war."
...
This is arguably the biggest strategic shift in Apex's business model. The company spent years diversifying away from U.S. dependence, and FY26 marks an inflection point.

"For the first time in Apex's history, non-U.S. export markets became the largest contrib to sales in FY '26, accounting for almost 52% of the total sales mix."
...
"Despite softness in the U.S.market, we were able to maintain our volumes close to last year's levels of 10,300 metric tons, backed by robust performance in the non-U.S. market mainly European Union, which grew 19% year-on-year in FY '26 and 15% year-on-year Q4 FY '26."
...
Management suggested the recovery is no longer theoretical and is already visible i the order book.

"We are getting back our orders into the U.S. already post removal or rather reduction of tariffs to 10%, because all the shrimp supplying countries are on the same level playing f as far as the tariff is concerned."
...
"We are well placed with regard to having a good market share and actually growing the further also in the European Union."

- Chowdary Karuturi, Managing Director & CFO

This suggests the company can grow significantly without major capacity expansio
...
Management highlighted approvals for new geographies beyond traditional market
...
"Since we cannot depend on just one market excessively, which has already been taught us as a lesson, that's one of the reasons why diversification also helps us."
...
"It's not really a point that there is a depreciation in the currency, it will be passed on to customer."
...
This was a notable industry observation and counters concerns about farmer distre

"Comparing India's farm gate pricing to many other countries, we are still higher, actual at this point."
...
Dev Information Technology is an Ahmedabad-based end-to-end IT services company founded in 1997, offering cloud, AI, blockchain, cybersecurity, enterprise application and managed IT services. The company serves a mix of Indian government agencies domestic corporates, and international clients, with a growing focus on Microsoft technologies. FY26 was deliberately a consolidation year, as management chose to prioritize the India market over exports amid geopolitical uncertainty, while simultaneously laying the groundwork for a North America push through the Xduc Infotech partnership.

## [Concall]

The company's most significant strategic move in FY2026 was the Xduce partnersh which gives Dev IT its first meaningful onsite presence in North America and the U after nearly three decades as a purely offshore business.

"Dev IT was totally an offshore business and we wanted to have our onsite presence so t we can have onsite and offsite hybrid business styles as well as acquire more enterprise-l customers from the North America and UK regions."
...
Management provided a clear revenue-sharing model for joint deals, with the bulk the economics flowing back to Dev IT as the offshore delivery engine.
...
Achieving all six Microsoft Solution Partner designations puts Dev IT in a small grob globally and is already translating into inbound enterprise deal flow that would not have been accessible otherwise.
...
"One of our customers, which is a leading sugar processing company in Texas, approach us through the Microsoft platform because we have achieved these competencies. We we able to close that 600,000 to 700,000 dollar business, which is significant for Dev IT pri to the Xduce integration."
...
"We are expecting around 200 crores worth of revenue for the current year. For next yea we are expecting around 15-20% growth from the current year."
...
CMR Green Technologies is one of India's leading recycled aluminium manufactur serving automotive and industrial customers through a circular-economy business model. Speaking after the company's strong stock market debut following an IPO tha was subscribed over 127 times, management outlined its growth plans, sustainability advantages, and expansion into newer aluminium recycling segments.

## [Reference]

Management believes recycled aluminium is positioned at the center of the global decarbonization trend due to its dramatically lower carbon footprint compared to primary aluminium. Combined with aluminium's infinite recyclability and growing consumption across industries, the company sees a long runway for sustained grow in the recycling sector.

"Recycled aluminium has the biggest decarbonization impact. The carbon generation is only 290 kgs against 16,000 kgs in the case of primary aluminium. So there is a very stro focus whenever we talk about sustainability and decarbonization. Aluminium comes in number one."

- Mohan Agarwal, CMD, CMR Green Technologies

Management remains highly optimistic about the future of the recycling industry, viewing the existing stock of aluminium in use as a perpetual source of raw materia

This structural advantage, coupled with decades of industry experience, underpins company's confidence in long-term growth.

"There is a huge amount of aluminium in use today. All of which is going to come back recycling not once but a number of times. So it's a mine above the earth. We will keep getting more and more feed and we'll keep producing more and more recycled products for our customers. I am ever so bullish on growth."
...
"Basically, our business generates enough cash to fund our capex, but whenever we get a large opportunity going forward, one of the reasons for becoming a public company is that we can look for larger growth opportunities. Something that we had been kind of leaving the past, being constrained by our ability to pursue those large opportunities. But being a public company, we should be able to now pursue those larger opportunities as they come and we can always come back to the market to raise primary when we need it."
...
![[images/TCS_IFB_Gulf_Oil_p3_img3.jpeg]]
...
![[images/TCS_IFB_Gulf_Oil_p3_img4.jpeg]]

Restacks

Write a comment...

## Augustus Ceasar Augustus Ceasar 2d
