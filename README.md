...
<picture>
  ...
  <img src="docs/img/system_overview-light.png" alt="FinData storage topology — the vault, SQLite source of truth, DuckDB graph cache, and serving layers" width="100%">
</picture>

*The storage topology (interactive HTML in
[`doc/design/diagrams/`](doc/design/diagrams/), generated by the
[archify](https://github.com/tt-a1i/archify) pipeline — every node carries
`SRC` evidence marks pinned to the commit that defines it).*
...
## The pipelines, visually

The same flows as rendered, validated diagrams (each one gated by an
integration suite — re-rendered whenever the suite changes; interactive
HTML in [`doc/design/diagrams/`](doc/design/diagrams/)).

**Ingest — newsletter PDFs to the knowledge graph**
([procedure](doc/procedures/markdown_parse.md)):

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/img/markdown_parse-dark.png">
  <img src="docs/img/markdown_parse-light.png" alt="markdown_parse pipeline: PDF/newsletter sources through conversion, parsing, curation, maintenance, and serving" width="100%">
</picture>
...
<picture>
  ...
  <img src="docs/img/derive_chain-light.png" alt="derive chain: extract relations, promote events, capture quotes and metrics into derived state" width="100%">
</picture>
