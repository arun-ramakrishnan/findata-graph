...
| `v_company`(1,063) `v_sector`(42) `v_sub_sector`(78) `v_super_sector`(9) `v_theme`(12) `v_edition`(108) `v_institution`(205) | filtered copies of `v_node` | TABLES (not views), same `id` space — company-only wrappers filter on them |
