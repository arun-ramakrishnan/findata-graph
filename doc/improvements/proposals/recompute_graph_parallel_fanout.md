...
The operator approved a 15 s wall ceiling for scalability rather than the original
12 s optimization target. The fork-pool implementation meets that ceiling; the
proposal is ready for the final QA/shakedown record.
