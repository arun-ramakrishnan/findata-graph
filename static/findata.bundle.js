  ...
  var require_getters = __commonJS({
    "node_modules/graphology-utils/getters.js"(exports) {
      ...
      function createNodeValueGetter(nameOrFunction, defaultValue) {
        ...
        var get = function(attributes2) {
          return coerceToDefault(attributes2[nameOrFunction]);
        };
        ...
        if (typeof nameOrFunction === "string") {
          ...
          getter.fromEntry = function(node, attributes2) {
            return get(attributes2);
          };
          ...
          getter.fromEntry = function(node, attributes2) {
            return coerceToDefault(nameOrFunction(node, attributes2));
          };
        } else {
      ...
      function createEdgeValueGetter(nameOrFunction, defaultValue) {
        ...
        if (typeof nameOrFunction === "string") {
          ...
          getter.fromEntry = function(edge, attributes2) {
            return get(attributes2);
          };
  ...
  var DocsView = class {
    ...
    async loadCatalog() {
      ...
      if (this.collection === "vault") {
        try {
          const entities2 = await this.ensureVault();
          this.renderVaultList(entities2);
          getEl("docs-count").textContent = `${entities2.length.toLocaleString()} notes`;
        } catch (error) {
    ...
    renderVaultList(entities2) {
      const byType = (t) => entities2.filter((e) => e.entity_type === t);
      const groups = [];
      groups.push({
        label: "Super Sectors",
...
`
  ...
  function validateGraph(graph) {
    ...
    graph.forEachNode(function(key, attributes2) {
      if (!Number.isFinite(attributes2.x) || !Number.isFinite(attributes2.y)) {
        throw new Error("Sigma: Coordinates of node ".concat(key, " are invalid. A node must have a numeric 'x' and 'y' attribute."));
      }
    });
  }
  function createElement(tag, style, attributes2) {
    ...
    if (attributes2) {
      for (var _k in attributes2) {
        element.setAttribute(_k, attributes2[_k]);
      }
    }
    return element;
  }
  ...
  var Sigma$1 = /* @__PURE__ */ (function(_TypedEventEmitter) {
    ...
    return _createClass(Sigma2, [{
      ...
      value: function renderHighlightedNodes() {
        ...
        context.clearRect(0, 0, this.width, this.height);
        var render2 = function render3(node) {
