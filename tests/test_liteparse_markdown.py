...
def test_looks_like_company_heading_sector_glue():
    ...
    assert _looks_like_company_heading("Engineering & Capital Goods Inox India | Small Cap | Engineering") is True
    assert _looks_like_company_heading("Financial Services SBFC Finance | Small Cap | Financial") is True
